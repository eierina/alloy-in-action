...
```*/
    ...
    #[automatically_derived]
    impl ::core::clone::Clone for SampleContractCalls {
        #[inline]
        fn clone(&self) -> SampleContractCalls {
            match self {
                SampleContractCalls::setValue(__self_0) => {
                    SampleContractCalls::setValue(::core::clone::Clone::clone(__self_0))
                }
                SampleContractCalls::getValue(__self_0) => {
                    SampleContractCalls::getValue(::core::clone::Clone::clone(__self_0))
                }
                SampleContractCalls::deposit(__self_0) => {
                    SampleContractCalls::deposit(::core::clone::Clone::clone(__self_0))
                }
                SampleContractCalls::withdraw(__self_0) => {
                    SampleContractCalls::withdraw(::core::clone::Clone::clone(__self_0))
                }
                SampleContractCalls::getBalance(__self_0) => {
                    SampleContractCalls::getBalance(
                        ::core::clone::Clone::clone(__self_0),
                    )
                }
                SampleContractCalls::revertWithError(__self_0) => {
                    SampleContractCalls::revertWithError(
                        ::core::clone::Clone::clone(__self_0),
                    )
                }
            }
    ...
    #[automatically_derived]
    impl ::core::clone::Clone for SampleContractErrors {
        #[inline]
        fn clone(&self) -> SampleContractErrors {
            match self {
                SampleContractErrors::SampleError(__self_0) => {
                    SampleContractErrors::SampleError(
                        ::core::clone::Clone::clone(__self_0),
                    )
                }
            }
    ...
    #[automatically_derived]
    impl ::core::clone::Clone for SampleContractEvents {
        #[inline]
        fn clone(&self) -> SampleContractEvents {
            match self {
                SampleContractEvents::ValueChanged(__self_0) => {
                    SampleContractEvents::ValueChanged(
                        ::core::clone::Clone::clone(__self_0),
                    )
                }
                SampleContractEvents::EtherReceived(__self_0) => {
                    SampleContractEvents::EtherReceived(
                        ::core::clone::Clone::clone(__self_0),
                    )
                }
                SampleContractEvents::EtherWithdrawn(__self_0) => {
                    SampleContractEvents::EtherWithdrawn(
                        ::core::clone::Clone::clone(__self_0),
                    )
                }
            }
